...
folder ID, it runs the following transformations:
  ...
  1. Load and verify the plate layout (load_and_verify_plate_layout).
  2. Load and verify the raw OD data files (load_and_verify_robotic_od_data).
  3. Extract the plate-reader files into a tidy dataframe
...
def parse_args():
    ...
    parser.add_argument('plate_layout', help='Path to plate_layout.csv')
...
def main():
    ...
    plate_layout = Path(args.plate_layout).resolve()
    ...
    # ------------------------------------------------------------------
    # 3. Extract plate-reader files into a dataframe
    # ------------------------------------------------------------------
